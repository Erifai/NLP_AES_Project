"""
Purpose: Build a scorer with Word, POS, Dep N-grams and Domain features
for mono, multi, cross-lingual scenarios (classification and regression)
"""
...
def main():
    ...
    itdirpath = "CrossLingualScoring/Datasets/IT-Parsed"
    dedirpath = "CrossLingualScoring/Datasets/DE-Parsed"
    czdirpath = "CrossLingualScoring/Datasets/CZ-Parsed"
...
#print(getLexFeatures("CrossLingualScoring/Datasets/DE-Parsed/1031_0003076_DE_C1.txt.parsed.txt", "de"))
#exit(1):
